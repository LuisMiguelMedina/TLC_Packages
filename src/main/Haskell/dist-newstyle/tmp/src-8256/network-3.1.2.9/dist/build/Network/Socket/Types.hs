...
{-# LINE 919 "Network\\Socket\\Types.hsc" #-}
pattern AF_IRDA             = Family (26)
{-# LINE 920 "Network\\Socket\\Types.hsc" #-}
...
{-# LINE 1122 "Network\\Socket\\Types.hsc" #-}
...
{-# LINE 1199 "Network\\Socket\\Types.hsc" #-}
...
s6_addr_offset :: Int
s6_addr_offset = ((0))
{-# LINE 1270 "Network\\Socket\\Types.hsc" #-}
...
{-# LINE 1298 "Network\\Socket\\Types.hsc" #-}

instance Storable In6Addr where
    sizeOf    _ = 16
{-# LINE 1301 "Network\\Socket\\Types.hsc" #-}
    alignment _ = 2
{-# LINE 1302 "Network\\Socket\\Types.hsc" #-}
